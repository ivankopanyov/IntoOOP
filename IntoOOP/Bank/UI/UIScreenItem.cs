...
/// <summary>Класс, описывающий элемент экрана.</summary>
public abstract class UIScreenItem
{
    ...
    /// <summary>Инициализация объекта элемента экрана.</summary>
    ...
    /// <summary>Очистка области экрана, в которой будет выведен элемент.</summary>
